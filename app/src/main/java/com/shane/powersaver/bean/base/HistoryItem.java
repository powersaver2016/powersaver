...
public class HistoryItem implements Serializable, Parcelable {
    ...
    protected HistoryItem(Parcel in) {
        m_time = in.readLong();
        m_offset = in.readLong();
        m_cmd = in.readByte();
        m_batteryLevel = in.readByte();
        m_batteryStatusValue = in.readByte();
        m_batteryHealthValue = in.readByte();
        m_batteryPlugTypeValue = in.readByte();
        m_batteryTemperatureValue = in.readString();
        m_batteryVoltageValue = in.readString();
        m_statesValue = in.readInt();
    }
