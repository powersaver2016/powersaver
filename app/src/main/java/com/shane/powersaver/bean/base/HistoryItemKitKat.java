...
public class HistoryItemKitKat extends HistoryItem implements Serializable, Parcelable {
    ...
    public String printBitDescriptions(int oldval, int newval) {
        String ret = "";
    ...
    private HistoryItemKitKat(Parcel in) {
        super(in);
    }

    public static final Parcelable.Creator<HistoryItemKitKat> CREATOR
            = new Parcelable.Creator<HistoryItemKitKat>() {

        @Override
        public HistoryItemKitKat createFromParcel(Parcel in) {
            return new HistoryItemKitKat(in);
        }

        @Override
        public HistoryItemKitKat[] newArray(int size) {
            return new HistoryItemKitKat[size];
        }
