...
public class HistoryItemJellyBean extends HistoryItem implements Serializable, Parcelable {
    ...
    private HistoryItemJellyBean(Parcel in) {
        super(in);
    }

    public static final Parcelable.Creator<HistoryItemJellyBean> CREATOR
            = new Parcelable.Creator<HistoryItemJellyBean>() {

        @Override
        public HistoryItemJellyBean createFromParcel(Parcel in) {
            return new HistoryItemJellyBean(in);
        }

        @Override
        public HistoryItemJellyBean[] newArray(int size) {
            return new HistoryItemJellyBean[size];
        }
